...
function preberiMeritveVitalnihZnakov() {
	...
	if (!ehrId || ehrId.trim().length == 0 ) {
		...
		$.ajax({
	    	...
	    	success: function (data) {
				var party = data.party;
				$("#rezultatMeritveVitalnihZnakov").html("<br/><span>Pridobivanje podatkov o teži pacienta <b>'" + party.firstNames + " " + party.lastNames + "'</b>.</span><br/><br/>");
					...
					$.ajax({
					    ...
					    success: function (res) {
					    	if (res.length > 0) {
					    		...
					    		$("#preberiMeritveVitalnihZnakovSporocilo").html("<span class='obvestilo label label-warning fade-in'>Ni podatkov1!</span>");
					    	}
					    },
					    error: function() {
